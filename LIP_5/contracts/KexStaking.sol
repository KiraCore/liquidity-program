...
contract KexStaking is Context {
     ...
     */
    function updateAccessControl(KriaAccessControl _accessControl) external {
        require(
    ...
    function stake(uint256 _amount) public onlyWhitelisted {
        ...
        require(
            ...
            "Stake: KexToken.TransferFrom: Failed to Stake!"
        );
    ...
    function unstake() public onlyWhitelisted {
        ...
        distributor.distribute(_msgSender(), reward);
        require(
            kexToken.transfer(_msgSender(), total),
            "Unstake: KexToken.Transfer: Failed to Unstake!"
        );
