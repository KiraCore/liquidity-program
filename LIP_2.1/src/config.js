...
console.log(process.env.REACT_APP_KEX_CONTRACT)
const config = {
    NETWORK: process.env.ENVIRONMENT === "production" ? "mainnet" : "kovan",
    ...
    INFURA_PROJECT_ID: process.env.REACT_APP_INFURA_PROJECT_ID || '23988ae61b6d4e3f851fce20720dae12'
}
