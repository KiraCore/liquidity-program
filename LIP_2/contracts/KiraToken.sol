...
contract KiraToken is ERC20, Ownable {
    ...
    // Events
    event WhitelistConfigured(address[] addrs, bool allow_deposit, bool allow_transfer, bool allow_unconditional_deposit, bool allow_unconditional_transfer);
    ...
    {
        return (_whitelist[addr].allow_deposit, _whitelist[addr].allow_transfer, _whitelist[addr].allow_unconditional_deposit, _whitelist[addr].allow_unconditional_transfer);
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            !freezed || _whitelist[from].allow_unconditional_transfer || _whitelist[to].allow_unconditional_deposit || (_whitelist[from].allow_transfer && _whitelist[to].allow_deposit),
